...
test("roles adjust the stopped-instance and idle-instance rules", () => {
  ...
  const idle = [{ instance_id: "i-btc", name: "Plain Bitcoind", instance_type: "m5.large", avg_max_cpu: 4.1, days: 30 },
    { instance_id: "i-mqtt", name: "mqtt-broker-open", instance_type: "t2.micro", avg_max_cpu: 3, days: 30 },
    { instance_id: "i-unsure", name: "sphinx-cache", instance_type: "t2.medium", avg_max_cpu: 3, days: 30 },
